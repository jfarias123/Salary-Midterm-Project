# -*- coding: utf-8 -*-
"""Copy of Salary Project.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1CyIumbWZZJ9HYkxTM4EXY5BRY0c_t3Jx
"""
...
sal[(sal['Gender'] != 'Male') &(sal['Gender'] != 'Female')]

sal = sal[sal.Gender != 'Other']

sal['Education Level'].value_counts()

sal['Education Level'] = sal['Education Level'].replace(["Bachelor's Degree", "Bachelor's"], "Bachelor's")
sal['Education Level'] = sal['Education Level'].replace(["Master's Degree", "Master's"], "Master's")
sal['Education Level'] = sal['Education Level'].replace(["Phd", "phD"], "PhD")

sal['Education Level'].value_counts()

sal.groupby('Job Title').filter(lambda x : len(x)>30)

X = sal[['Age','Gender','Education Level', 'Job Title','Years of Experience']]
...
plt.title("Actual vs. predicted Salary",fontsize=25)
plt.xlabel("Actual Salary",fontsize=18)
...
print('r2:', r2_score(y_test, pred, multioutput='variance_weighted'))
